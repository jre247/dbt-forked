create table "graph_selection_tests_007"."summary_expected" (
	gender VARCHAR(10),
    ct BIGINT
);

insert into "graph_selection_tests_007"."summary_expected" (gender, ct) values
('Female', 40),
('Male', 60);

create table "graph_selection_tests_007"."seed" (
...
insert into "graph_selection_tests_007"."seed" (first_name, last_name, email, gender, ip_address) values
